...
class letrak: UIViewController {
    
    var letraminuscula = AVAudioPlayer()
    var animalcomaletrak = AVAudioPlayer()
    ...
    override func viewDidLoad() {
        ...
        let movieURL:NSURL? = NSURL(string: "http://colegiosoer.com.br/letrak.3gp")
    ...
    @IBAction func animal(sender: AnyObject) {
        ...
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letrakkiwi", ofType: "wav")!)
        ...
        // Play the sound
        do {
            animalcomaletrak = try AVAudioPlayer(contentsOfURL: alertSound)
        } catch _{
        }
        
      
        animalcomaletrak.prepareToPlay()
        animalcomaletrak.play()
    ...
    @IBAction func letraminuscula(sender: AnyObject) {
        // Set the sound file name & extension
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letrakminuscula", ofType: "wav")!)
    ...
    @IBAction func letramaiuscula(sender: AnyObject) {
        // Set the sound file name & extension
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letrakmaiuscula", ofType: "wav")!)
