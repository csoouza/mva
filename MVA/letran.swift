...
class letran: UIViewController {
    
    var letraminuscula = AVAudioPlayer()
    var narwhal = AVAudioPlayer()
    ...
    override func viewDidLoad() {
        ...
        let movieURL:NSURL? = NSURL(string: "http://colegiosoer.com.br/letran.3gp")
    ...
    @IBAction func animal(sender: AnyObject) {
        ...
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letrannarval", ofType: "wav")!)
        ...
        // Play the sound
        do {
            narwhal = try AVAudioPlayer(contentsOfURL: alertSound)
        } catch _{
        }
        
      
        narwhal.prepareToPlay()
        narwhal.play()
    ...
    @IBAction func letraminuscula(sender: AnyObject) {
        // Set the sound file name & extension
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letranminuscula", ofType: "wav")!)
    ...
    @IBAction func letramaiuscula(sender: AnyObject) {
        // Set the sound file name & extension
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letranmaiuscula", ofType: "wav")!)
