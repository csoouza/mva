...
class letraj: UIViewController {
    
    var letraminuscula = AVAudioPlayer()
    var jacare = AVAudioPlayer()
    ...
    override func viewDidLoad() {
        ...
        let movieURL:NSURL? = NSURL(string: "http://colegiosoer.com.br/letraj.3gp")
    ...
    @IBAction func animal(sender: AnyObject) {
        ...
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letrajjacare", ofType: "wav")!)
        ...
        // Play the sound
        do {
            jacare = try AVAudioPlayer(contentsOfURL: alertSound)
        } catch _{
        }
        
      
        jacare.prepareToPlay()
        jacare.play()
    ...
    @IBAction func letraminuscula(sender: AnyObject) {
        // Set the sound file name & extension
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letrajminuscula", ofType: "wav")!)
    ...
    @IBAction func letramaiuscula(sender: AnyObject) {
        // Set the sound file name & extension
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letrajmaiuscula", ofType: "wav")!)
