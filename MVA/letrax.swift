...
class letrax: UIViewController {
    
    var letraminuscula = AVAudioPlayer()
    var ximango = AVAudioPlayer()
    ...
    override func viewDidLoad() {
        ...
        let movieURL:NSURL? = NSURL(string: "http://colegiosoer.com.br/letrax.3gp")
    ...
    @IBAction func animal(sender: AnyObject) {
        ...
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letraxximango", ofType: "wav")!)
        ...
        // Play the sound
        do {
            ximango = try AVAudioPlayer(contentsOfURL: alertSound)
        } catch _{
        }
        
      
        ximango.prepareToPlay()
        ximango.play()
    ...
    @IBAction func letraminuscula(sender: AnyObject) {
        // Set the sound file name & extension
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letraxminuscula", ofType: "wav")!)
    ...
    @IBAction func letramaiuscula(sender: AnyObject) {
        // Set the sound file name & extension
        let alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("letraxmaiuscula", ofType: "wav")!)
